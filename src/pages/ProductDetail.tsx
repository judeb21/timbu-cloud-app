...
function ProductDetail() {
  ...
  >([]);
  const [reviewHeader, setReviewHeader] = useState("reviews");
  ...
  const populateRecentlyViewed = (product: ProductDetailType) => {
    ...
    const recentViewed: Array<recentlyViewedProduct> = JSON.parse(
      recentViewedString as string
    );
    ...
    if (recentViewed !== null && recentViewed.length > 0) {
      ...
      const productIsViewed = recentViewed.some(
        (item) => item.id === product.id
      );

      if (productIsViewed) {
        recentViewed.filter((product) => product.id !== viewProduct.id);
      ...
      productsReview.filter((product) => product.id !== viewProduct.id);
  ...
  const changeReviews = (name: string) => {
    setReviewHeader(name);
  };

  const setColorPreference = (name: string) => {
    setColor(name);
  }
                        ...
                        <div className="product--color__variations">
                          <label>
                            <input
                              ...
                              onChange={() => setColorPreference("primary")}
                            />
                          </label>
                          ...
                          <label>
                            <input
                              ...
                              onChange={() => setColorPreference("orange")}
                            />
                          </label>
                          ...
                          <label>
                            <input
                              ...
                              onChange={() => setColorPreference("indigo")}
                            />
                          </label>
                          ...
                          <label>
                            <input
                              ...
                              onChange={() => setColorPreference("blue-grey")}
                            />
                          </label>
                        </div>
                      </div>
                  ...
                  <div className="product--review__container">
                    <div className="product--review__head">
                      <div className="product--review__header">
                        <h5
                          className={
                            reviewHeader === "description" ? "active" : ""
                          }
                          onClick={() => changeReviews("description")}
                        >
                          Description
                        </h5>
                        <h5
                          onClick={() => changeReviews("reviews")}
                          className={reviewHeader === "reviews" ? "active" : ""}
                        >
                          Reviews <span>1</span>
                        </h5>
                        <h5
                          className={reviewHeader === "support" ? "active" : ""}
                          onClick={() => changeReviews("support")}
                        >
                          Support
                        </h5>
                      </div>
                            ...
                            <article className="product--review__card">
                              ...
                              <div className="product--review__content">
                                ...
                                <div className="product--review__content-body">
                                  <p>
                                    What i ordered was exactly what i got. and
                                    the delivery was so smooth, packing was
                                    top-notch, i totally recommend this{" "}
                                  </p>
